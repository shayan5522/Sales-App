...
class OnlineReportScreen extends StatefulWidget {
  const OnlineReportScreen({super.key});

  @override
  State<OnlineReportScreen> createState() => _OnlineReportScreenState();
}

final ScrollController _transactionScrollController = ScrollController();

class _OnlineReportScreenState extends State<OnlineReportScreen> {
